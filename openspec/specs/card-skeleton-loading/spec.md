# card-skeleton-loading Specification

## Purpose
Define local skeleton loading behavior for FormoAtlas market data cards, ranking tables, and visualization containers so in-flight requests do not appear as empty data.
