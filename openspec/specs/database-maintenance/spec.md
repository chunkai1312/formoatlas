## Purpose
Define the developer-facing MongoDB backup and restore tooling required to protect FormoAtlas local development data and support safe destructive restore workflows.
